            ...
            <main class="py-4">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            @auth
                                <a href="{{route('discussions.create')}}" class="btn btn-info my-2" style="width: 100%;">Add Discussion</a>
                            @else
                                <a href="{{route('login')}}" class="btn btn-info my-2" style="width: 100%;">Sign In to Add Discussion</a>
                            @endauth
                            <div class="card">
